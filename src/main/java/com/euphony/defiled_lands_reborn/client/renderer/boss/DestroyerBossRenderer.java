...
public class DestroyerBossRenderer extends MobRenderer<DestroyerBoss, DestroyerModel> {
    
    private static final ResourceLocation DESTROYER_LOCATION =
            Utils.prefix("textures/entity/the_destroyer.png");
    
    private static final ResourceLocation DESTROYER_EXPLOSION_LOCATION =
            Utils.prefix("textures/entity/the_destroyer_explosion.png");
    
    public static final RenderType DECAL = RenderType.entityDecal(DESTROYER_LOCATION);
    
    public DestroyerBossRenderer(EntityRendererProvider.Context context) {
        super(context, new DestroyerModel(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
    }
    
    @Override
    protected void setupRotations(DestroyerBoss entity, PoseStack poseStack,
    ...
    @Override
    public void render(DestroyerBoss entity, float entityYaw, float partialTicks,
                       PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        
        RenderLivingEvent.Pre<DestroyerBoss, DestroyerModel> pre =
        ...
        if (type != null) {
            if (entity.deathTime > 0 || entity.getInvulTime() > 0) {
                ...
                VertexConsumer explosion = buffer.getBuffer(RenderType.entityTranslucent(DESTROYER_EXPLOSION_LOCATION));
    ...
    @Override
    public ResourceLocation getTextureLocation(DestroyerBoss entity) {
