...
public class BlockTagGenerator extends BlockTagsProvider {
    ...
    public BlockTagGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, ExistingFileHelper existingFileHelper) {
        super(output, lookupProvider, DefiledLandsPreborn.MOD_ID, existingFileHelper);
    }
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
                DLBlocks.DEFILED_STONE.get(),
                DLBlocks.DEFILED_SANDSTONE.get(),
                DLBlocks.HEPHAESTITE_ORE.get(),
                DLBlocks.HEPHAESTITE_BLOCK.get(),
                DLBlocks.UMBRIUM_ORE.get(),
                DLBlocks.UMBRIUM_BLOCK.get(),
                DLBlocks.SCARLITE_ORE.get(),
                DLBlocks.SCARLITE_BLOCK.get(),
                ...
                DLBlocks.RAVAGING_BRICKS.get(),
                DLBlocks.RAVAGING_STONE.get()
        );
        
        tag(BlockTags.MINEABLE_WITH_SHOVEL).add(
                DLBlocks.DEFILED_DIRT.get(),
                DLBlocks.DEFILED_GRASS_BLOCK.get(),
                DLBlocks.DEFILED_GRAVEL.get()
        );
        
        tag(BlockTags.MINEABLE_WITH_AXE).add(
                DLBlocks.SCURONOTTE.get(),
                DLBlocks.VILESPINE.get(),
                DLBlocks.BLASTEM.get()
        );
        ...
        tag(DLBlockTags.ORES).add(
                DLBlocks.HEPHAESTITE_ORE.get(),
                DLBlocks.UMBRIUM_ORE.get(),
                DLBlocks.SCARLITE_ORE.get()
        );
        
        tag(DLBlockTags.STORAGE_BLOCKS).add(
                DLBlocks.HEPHAESTITE_BLOCK.get(),
                DLBlocks.UMBRIUM_BLOCK.get(),
                DLBlocks.SCARLITE_BLOCK.get()
        );
        
        tag(DLBlockTags.BASE_DEFILED_SURFACE).add(
                DLBlocks.DEFILED_DIRT.get(),
                DLBlocks.DEFILED_GRASS_BLOCK.get(),
