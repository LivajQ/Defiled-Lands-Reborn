...
public class ItemTagGenerator extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(DLItemTags.FOOD_POISONING).add(
                DLItems.SCUTTLER_EYE.get(),
                DLItems.BLACK_HEART.get(),
        ...
        tag(ItemTags.HEAD_ARMOR).add(
                DLItems.UMBRIUM_HELMET.get(),
                DLItems.BOOK_WYRM_SCALE_HELMET.get(),
                DLItems.GOLDEN_BOOK_WYRM_SCALE_HELMET.get()
        );
        
        tag(ItemTags.CHEST_ARMOR).add(
                DLItems.UMBRIUM_CHESTPLATE.get(),
                DLItems.BOOK_WYRM_SCALE_CHESTPLATE.get(),
                DLItems.GOLDEN_BOOK_WYRM_SCALE_CHESTPLATE.get()
        );
        
        tag(ItemTags.LEG_ARMOR).add(
                DLItems.UMBRIUM_LEGGINGS.get(),
                DLItems.BOOK_WYRM_SCALE_LEGGINGS.get(),
                DLItems.BOOK_WYRM_SCALE_BOOTS.get()
        );
        
        tag(ItemTags.FOOT_ARMOR).add(
                DLItems.UMBRIUM_BOOTS.get(),
                DLItems.BOOK_WYRM_SCALE_BOOTS.get(),
                DLItems.GOLDEN_BOOK_WYRM_SCALE_BOOTS.get()
        );
         */
        ...
        tag(DLItemTags.RAVAGING_TOOLS).add(
                DLItems.RAVAGING_AXE.get(),
                DLItems.RAVAGING_PICKAXE.get(),
                DLItems.RAVAGING_SHOVEL.get()
        );
    }
}
